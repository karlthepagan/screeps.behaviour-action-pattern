var action = new Creep.Action('attacking');
...
action.newTarget = function(creep){
    let validColor = flagEntry => (
        (flagEntry.color == FLAG_COLOR.claim.attackController.color && flag.secondaryColor == FLAG_COLOR.claim.attackController.secondaryColor) 
    );
